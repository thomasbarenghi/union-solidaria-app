...
export const titleRegex = /^[\w\s!@#$%^&*()_+\-=[\]{};':"\\|,.<>/?`~´ñÇáéíóúüÁÉÍÓÚÜ\d]{2,50}$/
export const descriptionRegex = /^[\w\s!@#$%^&*()_+\-=[\]{};':"\\|,.<>/?`~À-ÿ]{2,1000}$/
...
export const organizationNameRegex = /^[\w\s!@#$%^&*()_+\-=[\]{};':"\\|,.<>/?`~´ñÇáéíóúüÁÉÍÓÚÜ\d]{2,50}$/
