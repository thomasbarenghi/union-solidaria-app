...
const EmptySkeleton = ({ isCurrent = false }: { isCurrent?: boolean }) => (
  <>
    <div className='flex aspect-square w-full flex-col items-center justify-center gap-1 border-[2px] border-dashed border-slate-200 p-3 h-full lg:p-10'>
      <TextElement type='subtitle' as='h2' className='w-full text-center !font-semibold !text-base md:!text-lg'>
