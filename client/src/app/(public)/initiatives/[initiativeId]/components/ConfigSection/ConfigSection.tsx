...
import { patchRequest } from '@/services/apiRequests.service'
...
const ConfigSection = ({ initiative, isLoading }: Props) => {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      await patchRequest(Endpoints.INITIATIVES_BY_ID(initiative._id), formData)
