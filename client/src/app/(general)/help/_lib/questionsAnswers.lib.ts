...
export const questionsAnswers: QuestionAnswer[] = [
  {
    ...
    answer: 'Union Solidaria es una organizacion que busca conectar a las personas con ONGs que necesitan ayuda.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Puedes donar dinero a través de nuestra plataforma, en unionsolidaria.com/donate .'
  },
  {
    question: '¿Cómo puedo participar de una iniciativa?',
    answer:
      'Para participar de una iniciativa, debes registrarte en nuestra plataforma y luego postularte a la iniciativa que quieras participar.'
  },
  {
